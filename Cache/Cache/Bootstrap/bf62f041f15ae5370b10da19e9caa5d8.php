...
<!-- Le styles -->
<link href="__PUBLIC__/www/layoutit/css/bootstrap-combined.min.css" rel="stylesheet">
<link href="__PUBLIC__/www/layoutit/css/layoutit.css" rel="stylesheet">

<!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
		<script src="__PUBLIC__/www/layoutit/js/html5shiv.js"></script>
	<![endif]-->

	<!-- Fav and touch icons -->
	<link rel="shortcut icon" href="__PUBLIC__/www/layoutit/img/favicon.png">
	
	<script type="text/javascript" src="__PUBLIC__/www/layoutit/js/jquery-2.0.0.min.js"></script>
	<!--[if lt IE 9]>
	<script type="text/javascript" src="http://code.jquery.com/jquery-1.9.1.min.js"></script>
	<![endif]-->
	<script type="text/javascript" src="__PUBLIC__/www/layoutit/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="__PUBLIC__/www/layoutit/js/jquery-ui.js"></script>
	<script type="text/javascript" src="__PUBLIC__/www/layoutit/js/jquery.ui.touch-punch.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/www/layoutit/js/jquery.htmlClean.js"></script>
<script type="text/javascript" src="__PUBLIC__/www/layoutit/ckeditor/ckeditor.js"></script>
<script type="text/javascript" src="__PUBLIC__/www/layoutit/ckeditor/config.js"></script>
<script type="text/javascript" src="__PUBLIC__/www/layoutit/js/scripts.js"></script>
</head>
...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container-fluid">
      ...
      <a class="brand" href="http://justjavac.com/tools/layoutit/"><img src="__PUBLIC__/www/layoutit/img/favicon.png"> 可视化布局<span class="label">BETA</span></a>
        ...
        <ul class="nav nav-list accordion-group">
          ...
          <li style="display: none;" class="boxes" id="elmBase">
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="icon-remove icon-white"></i>删除</a> <span class="drag label"><i class="icon-move"></i>拖动</span> <span class="configuration"> <span class="btn-group"> <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">样式 <span class="caret"></span></a>
              ...
              <div class="view"> <img alt="140x140" src="__PUBLIC__/www/layoutit/img/a.jpg"> </div>
            </div>
          </li>
        </ul>
        <ul class="nav nav-list accordion-group">
          ...
          <li style="display: none;" class="boxes" id="elmComponents">
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="icon-remove icon-white"></i>删除</a> <span class="drag label"><i class="icon-move"></i>拖动</span>
              ...
              <div class="view">
                <ul class="thumbnails">
                  <li class="span4">
                    <div class="thumbnail"> <img alt="300x200" src="__PUBLIC__/www/layoutit/img/people.jpg">
                  ...
                  <li class="span4">
                    <div class="thumbnail"> <img alt="300x200" src="__PUBLIC__/www/layoutit/img/city.jpg">
                      <div class="caption" contenteditable="true">
                        <h3>哈佛结构</h3>
                  ...
                  <li class="span4">
                    <div class="thumbnail"> <img alt="300x200" src="__PUBLIC__/www/layoutit/img/sports.jpg">
                      <div class="caption" contenteditable="true">
                        <h3>改进型哈佛结构</h3>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="icon-remove icon-white"></i>删除</a> <span class="drag label"><i class="icon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-mini" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-mini" href="#" rel="well">嵌入</a> </span>
              ...
              <div class="view">
                <div class="media"> <a href="#" class="pull-left"> <img src="__PUBLIC__/www/layoutit/img/a_002.jpg" class="media-object"> </a>
              ...
              <div class="view">
                <div class="carousel slide" id="myCarousel">
                  ...
                  <div class="carousel-inner">
                    <div class="item active"> <img alt="" src="__PUBLIC__/www/layoutit/img/1.jpg">
                      <div class="carousel-caption" contenteditable="true">
                        <h4>棒球</h4>
                        <p>棒球运动是一种以棒打球为主要特点，集体性、对抗性很强的球类运动项目，在美国、日本尤为盛行。</p>
                      </div>
                    </div>
                    <div class="item"> <img alt="" src="__PUBLIC__/www/layoutit/img/2.jpg">
                      <div class="carousel-caption" contenteditable="true">
                        <h4>冲浪</h4>
                        <p>冲浪是以海浪为动力，利用自身的高超技巧和平衡能力，搏击海浪的一项运动。运动员站立在冲浪板上，或利用腹板、跪板、充气的橡皮垫、划艇、皮艇等驾驭海浪的一项水上运动。</p>
                      </div>
                    </div>
                    <div class="item"> <img alt="" src="__PUBLIC__/www/layoutit/img/3.jpg">
                      <div class="carousel-caption" contenteditable="true">
                        <h4>自行车</h4>
