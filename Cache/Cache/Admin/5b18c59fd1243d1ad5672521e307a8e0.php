...
<form name="myform" action="<?php echo U('Node/listorder');?>" method="post">
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
            ...
            <th align="left"><?php echo L('node_title');?></th>
			<th width="80" align="left"><?php echo L('node_name');?></th>
	...
	<?php if(is_array($nodes)): $i = 0; $__LIST__ = $nodes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr><td colspan="7"  bgcolor="F8FAFC"><?php echo ($r[groupinfo][name]); ?></td></tr>
		<?php echo ($r[data]); endforeach; endif; else: echo "" ;endif; ?>
	</tbody>
    </table>
